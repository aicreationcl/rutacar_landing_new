...
export function mensajeErrorEnvio(status: number, body: unknown): string {
  ...
  switch (status) {
    ...
    case 429:
      return "Alcanzaste el límite de solicitudes de cotización. Intenta de nuevo más tarde o escríbenos por WhatsApp.";
    case 503:
      return "El servicio de cotización no está disponible en este momento. Escríbenos por WhatsApp mientras tanto.";
    case 502:
      return "No pudimos procesar tu cotización. Intenta de nuevo en unos minutos.";
    default:
      return mensaje ?? "Ocurrió un error inesperado al enviar tu cotización. Intenta de nuevo.";
  }
}
